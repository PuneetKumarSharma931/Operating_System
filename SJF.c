//Program for SJF (Non-Preemptive) CPU Scheduling Algorithm
...
void waiting(int wait[], int arrival[], int burstTime[], int processId[], int n) {
...
int main() {
    ...
    waiting(wait, arrival, burstTime, processId, n);
